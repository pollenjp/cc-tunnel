...
// docker/docker v28+incompatible calls sockets.DialPipe which was removed from
// docker/go-connections v0.7.0 for non-Windows builds. Pin to v0.5.0 which
// includes the Linux stub. moby/moby/client only uses ConfigureTransport and
// tlsconfig, both of which are present in v0.5.0.
